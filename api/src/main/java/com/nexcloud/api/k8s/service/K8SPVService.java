...
@Service
public class K8SPVService {
	static final Logger logger = LoggerFactory.getLogger(K8SPVService.class);
	 ...
	 * @throws Exception
	 */
	public ResponseEntity<ResponseData> getPersistentvolumeClaim( String cluster_id )  throws Exception
	{
		String query								= null;
