...
@Service
public class NodeContainerCPUService {
	static final Logger logger = LoggerFactory.getLogger(NodeContainerCPUService.class);
	 ...
	 * @throws Exception
	 */
	public ResponseEntity<ResponseData> getNodeContainerCpuUsedCore( String cluster_id, String node_name, String container, String start, String end ) throws Exception
	{
		String query								= null;
