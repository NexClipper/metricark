...
public class HostCPUService {
	static final Logger logger = LoggerFactory.getLogger(HostCPUService.class);
	 ...
	 * @throws Exception
	 */
	public ResponseEntity<ResponseData> getProcessResourceCpuUsage( String cluster_id, String node_name, String start, String end )  throws Exception
	{
		String query								= null;
		...
		try{
			...
			query									= "sum (rate (container_cpu_usage_seconds_total{param}[3m])) by (id)";
