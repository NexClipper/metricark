...
public class HostMemoryService {
	static final Logger logger = LoggerFactory.getLogger(HostMemoryService.class);
	 ...
	 * @throws Exception
	 */
	public ResponseEntity<ResponseData> getProcessResourceMemoryUsage( String cluster_id, String node_name, String start, String end )  throws Exception
	{
		String query								= null;
