...
public class ContainerService {
	 ...
	 * @throws Exception
	 */
	public ResponseEntity<ResponseData> getContainerStatusRunning( String cluster_id, String node_name )  throws Exception
	{
		String query								= null;
		...
		String param								= null;
		try{
			param									= "{instance=~'"+node_name+"', container_state='running'}";
