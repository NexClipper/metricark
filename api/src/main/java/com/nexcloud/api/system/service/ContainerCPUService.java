...
@Service
public class ContainerCPUService {
	static final Logger logger = LoggerFactory.getLogger(ContainerCPUService.class);
	 ...
	 * @throws Exception
	 */
	public ResponseEntity<ResponseData> getContainerResourceCpuUsage( String cluster_id, String node_name, String container_name, String pod_name, String namespace, String start, String end )  throws Exception
	{
		String query								= null;
		...
		try{
			...
			query									= "sum (rate (container_cpu_usage_seconds_total{param}[3m])) by (container, pod)";
