...
@Service
public class ContainerMemoryService {
	static final Logger logger = LoggerFactory.getLogger(ContainerMemoryService.class);
	 ...
	 * @throws Exception
	 */
	public ResponseEntity<ResponseData> getContainerResourceMemoryUsage( String cluster_id, String node_name, String container_name, String pod_name, String namespace, String start, String end )  throws Exception
	{
		String query								= null;
