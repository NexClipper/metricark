...
const ServicesList: React.FC<{ data: any }> = ({ data }) => {
  ...
  const columns = [
    ...
    // },
    {
      title: "ClusterIP",
      dataIndex: "clusterIP",
      sorter: createStringSorter("clusterIP"),
      filters: createFilter(tableData, "clusterIP"),
      width: "10%",
    },
    {
      title: "Namespace",
  ...
  return (
    <x.div p={20}>
      <SimpleCard title="Services List" col={1}>
        <Table
          columns={columns}
